        ...
        <div className="md:col-span-8 bg-white border border-[#D7E5E8] rounded-2xl p-6 shadow-xs">
          ...
          {step === 5 && (
            <div className="space-y-4 text-xs">
              <h2 className="text-base font-bold text-[#1F2937] mb-2">Step 5: Menu Categories</h2>
          ...
          {step === 6 && (
            <div className="space-y-4 text-xs">
              <h2 className="text-base font-bold text-[#1F2937] mb-2">Step 6: Add Menu Items</h2>
          ...
          {/* STEP 7: Visual Storefront Preview */}
          {step === 7 && (
            <div className="space-y-5 text-xs">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-base font-bold text-[#1F2937]">Step 7: Visual Storefront Preview</h2>
                      ...
                      <div className="flex flex-wrap items-center gap-3 mt-1.5 text-[11px] text-white/80 font-medium">
                        {detailsForm.area && (
                          <span className="flex items-center gap-1">
                            <MapPin className="w-3.5 h-3.5 text-[#3A7D7C]" /> {detailsForm.area}{detailsForm.city ? `, ${detailsForm.city}` : ''}
                          </span>
                        )}
                        <span className="flex items-center gap-1">
                          <Clock className="w-3.5 h-3.5 text-amber-300" /> 10:00 AM - 11:30 PM
                        </span>
          ...
          {/* STEP 8: Subdomain Branding Add-On (₹99/mo) */}
          {step === 8 && (
            <div className="space-y-5 text-xs">
              <div>
                <span className="text-[11px] font-black uppercase tracking-wider text-amber-700 bg-amber-100 px-2.5 py-0.5 rounded-full border border-amber-200">
                  Step 8: Custom Subdomain Branding
                </span>
              ...
              {!restaurant?.custom_subdomain_enabled ? (
                ...
                <div className="bg-emerald-50 rounded-2xl border border-emerald-200 p-5 flex items-center justify-between text-emerald-900 shadow-2xs">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-sm">Official Custom Subdomain Active</h4>
                      <p className="text-xs text-emerald-700 font-medium">Your official restaurant name <code className="font-bold bg-white px-1.5 py-0.5 rounded border border-emerald-200 text-emerald-900">https://{restaurant?.custom_subdomain_slug || restaurant?.slug}.jattamkommerce.com</code> is active. No payment required!</p>
                    </div>
                  </div>
                  <span className="px-4 py-2 bg-emerald-600 text-white font-extrabold text-xs rounded-full shadow-md flex items-center gap-1.5 shrink-0">
